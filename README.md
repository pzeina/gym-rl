...
| `squad_screen` | `squad_screen_v21` | 0.99 ± 0.02 (N=100) | 0.99 ± 0.02 (N=100) | 0.4 pt | 13% | 1% | 99/99 | 99% | pass |
| `patrol_brique` | `patrol_brique_v51_seed18` | 0.99 ± 0.02 (N=100) | 0.99 ± 0.02 (N=100) | 1.1 pt | 4% | 0% | 99/99 | 80% | pass |
| `defend_brique` | `defend_brique_v21` | 1.00 ± 0.00 (N=100) | 1.00 ± 0.00 (N=100) | 0.2 pt | 3% | 0% | 100/100 | 99% (sitrep, 0.064/sitrep) | pass |
| `platoon` | `platoon_v21_seed14` | 0.99 ± 0.02 (N=100) | 0.97 ± 0.03 (N=100) | 1.0 pt | 36% | 1% | 99/99 | 74% | pass |
| `platoon_hard` | `platoon_hard_v13_seed13` | 0.92 ± 0.05 (N=100) | 0.77 ± 0.08 (N=100) | 8.7 pt | 46% | 4% | 92/92 | 2% | pass |

All 9 runs trained against the same `cohort/` tree (`19a8da08`) on the shipped reward defaults, no `--reward` overrides. Generated by `scripts/results_table.py`; `tests/test_results_table.py` fails if this table and the runs disagree.
