...
|---|---|---|---|---|---|---|---|---|---|
| `fireteam` | `fireteam_v15` | 0.97 ± 0.03 (N=100) | 0.90 ± 0.06 (N=100) | 5.7 pt | 3% | 1% | 97/97 | 72% | pass |
| `fireteam_defend` | `fireteam_defend_v26` | 0.99 ± 0.02 (N=100) | 0.98 ± 0.03 (N=100) | 1.2 pt | 7% | 0% | 99/99 | 97% (sitrep, 0.036/sitrep) | pass |
| `squad` | `squad_v33_seed15` | 0.95 ± 0.04 (N=100) | 0.95 ± 0.04 (N=100) | 4.1 pt | 31% | 1% | 95/95 | 84% | pass |
| `squad_recon` | `squad_recon_v14` | 0.96 ± 0.04 (N=100) | 0.98 ± 0.03 (N=100) | 2.9 pt | 4% | 0% | 96/96 | 92% | pass |
| `squad_screen` | `squad_screen_v20` | 1.00 ± 0.00 (N=100) | 0.97 ± 0.03 (N=100) | 0.2 pt | 11% | 0% | 100/100 | 95% | pass |
| `patrol_brique` | `patrol_brique_v48_seed19` | 0.97 ± 0.03 (N=100) | 0.96 ± 0.04 (N=100) | 2.2 pt | 8% | 1% | 97/97 | 86% | pass |
| `defend_brique` | `defend_brique_v20` | 1.00 ± 0.00 (N=100) | 0.98 ± 0.03 (N=100) | 0.9 pt | 10% | 0% | 100/100 | 98% (sitrep, 0.045/sitrep) | pass |
| `platoon` | `platoon_v18_seed15` | 0.88 ± 0.06 (N=100) | 0.99 ± 0.02 (N=100) | 4.2 pt | 42% | 12% | 88/88 | 58% | pass |
| `platoon_hard` | `platoon_hard_v9_seed13` | 0.90 ± 0.06 (N=100) | 0.91 ± 0.06 (N=100) | 8.5 pt | 35% | 0% | 90/90 | 1% | pass |

All 9 runs trained against the same `cohort/` tree (`0c25b034`) on the shipped reward defaults, no `--reward` overrides. Generated by `scripts/results_table.py`; `tests/test_results_table.py` fails if this table and the runs disagree.
