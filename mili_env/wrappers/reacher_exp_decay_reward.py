...
from mili_env.envs.classes.qlearning_agent import QLearningAgent
...
class ReacherRewardWrapper(gym.Wrapper):
    ...
    def __init__(self, env: gym.Env, decay_factor: float = 0.9, history_length: int = 50) -> None:
        ...
        # Agent reference (will be set from training loop)
    ...
    def set_agent(self, agent: QLearningAgent) -> None:
        """Set the agent reference for memory updates."""
        self.agent = agent
