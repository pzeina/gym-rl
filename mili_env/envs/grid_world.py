...
class GridWorldEnv(gym.Env):
    """Simple grid world environment with a target and an agent."""

    custom_metadata: ClassVar[dict] = {"render_modes": ["human", "rgb_array"], "render_fps": 4}
    ...
    def __init__(self, render_mode: str | None = None, size: int = 5) -> None:
        ...
        self.observation_space = spaces.Dict(
            {
                "position": spaces.Box(0, size - 1, shape=(2,)),
                "direction": spaces.Box(0, 1, shape=(1,)),
                "target": spaces.Box(0, size - 1, shape=(2,)),
            }
        )
    ...
    def _render_frame(self) -> np.ndarray | None:
        ...
        pygame.draw.rect(
            ...
            (255, 0, 0),
            pygame.Rect(
                tuple(pix_square_size * self._target_location),
