...
def test_core_is_the_pre_v110_width():
    ...
    # 4 DONE-heard) + 4 interrogative cycle (status-COMPLETE-heard),
    # appended to BOTH profiles like every appended block
    assert obs_dim("full") == OBS_DIM == 215 + 94 + 14 + 23 + 11 + 4
    assert obs_dim("core") == 161 + 94 + 14 + 23 + 11 + 4
