...
class TestAgentMovement(unittest.TestCase):
    ...
    def test_idle_action(self):
        ...
        self.agent.move(Moves.IDLE.value)
    ...
    def test_forward_movement(self):
        ...
        self.agent.move(Moves.FORWARD.value)
    ...
    def test_backward_movement(self):
        ...
        self.agent.move(Moves.BACKWARD.value)
    ...
    def test_rotation_actions(self):
        ...
        # Test left rotation
        self.agent.move(Moves.ROTATE_LEFT.value)
        left_angle = self.agent.get_direction()

        # Test right rotation
        self.agent.move(Moves.ROTATE_RIGHT.value)
    ...
    def test_energy_consumption(self):
        ...
        # Simulate environment step to process energy with proper action format
        action_dict = {
            f"agent_{i}": {
                "elementary_act": 0,
                "combat": {"move": Moves.IDLE.value, "fire_enemy": self.env.num_agents},
    ...
    def test_movement_sequence(self):
        ...
        moves = [
            Moves.FORWARD.value,
            Moves.ROTATE_LEFT.value,
            Moves.FORWARD.value,
            Moves.ROTATE_RIGHT.value,
        ]
